...
VSPM_CFG_alt="E2CONFIG"
VSPM_CFG_koelsch="M2CONFIG"
VSPM_CFG_gose="M2CONFIG"
VSPM_CFG_lager="H2CONFIG"
...
do_clean_source() {
	rm -Rf ${KERNELSRC}/include/vspm_public.h
	rm -Rf ${KERNELSRC}/include/vsp_drv.h
	rm -Rf ${KERNELSRC}/include/tddmac_drv.h
	rm -Rf ${KERNELSRC}/include/vspm_if.h
	rm -Rf ${BUILDDIR}/include/vspm_if.h
	rm -Rf ${KERNELSRC}/include/vspm.symvers
}
